...
/**
 ...
 @param faceIDSDKVersion SDK的版本信息
 */
+ (void)licenseForIpv6NetworkWithVersion:(NSString *)faceIDSDKVersion result:(void(^)(BOOL isLicense))result;
...
/**
 ...
 @return SDK授权状态。对应MG_RETCODE类型.
 */
+ (int)licenseForLicenseInfo:(NSData *)licenseData;
