...
public struct ImageCacheTool: Cacheable {
    
    public let module: CacheModule
    public let path: String
    public let workQueue: DispatchQueue
    public let useDiskCache: Bool
    public let cache: ImageCache
    
    public init(module: CacheModule, path: String = "", memoryCountLimit: Int = 5, useDiskCache: Bool = false) {
        self.module = module
