...
extension FileHelper {
    ...
    static func temporaryDirectory(for type: PHMediaType) -> String {
    ...
    static func getTemporaryUrl(by type: PHMediaType, fileType: FileType, filename: String = "") -> URL {
        return getTemporaryUrl(by: type, utType: fileType.utType, filename: filename)
    }
    
    static func getTemporaryUrl(by type: PHMediaType, utType: CFString, filename: String = "") -> URL {
