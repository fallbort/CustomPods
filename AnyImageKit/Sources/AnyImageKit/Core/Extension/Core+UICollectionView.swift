...
extension UICollectionView {
    ...
    public func scrollToFirst(at scrollPosition: UICollectionView.ScrollPosition, animated: Bool) {
    ...
    public func scrollToLast(at scrollPosition: UICollectionView.ScrollPosition, animated: Bool) {
        guard numberOfSections > 0 else { return }
