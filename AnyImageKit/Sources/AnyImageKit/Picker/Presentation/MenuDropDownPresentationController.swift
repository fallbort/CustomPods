...
public final class MenuDropDownPresentationController: UIPresentationController {
    ...
    public var extraTopMenuHeight: CGFloat = 0
    ...
    public override func presentationTransitionWillBegin() {
        ...
        if let containerView = containerView {
            ...
            opaqueView.backgroundColor = UIColor.white
