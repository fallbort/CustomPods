...
extension PickerManager {
    ...
    public func fetchCameraRollAlbum(completion: @escaping (Album) -> Void) {
    ...
    public func fetchAlbum(_ album: Album, completion: @escaping (Album) -> Void) {
            ...
            for assetCollection in assetCollections {
                ...
                if assetCollection.localIdentifier == album.identifier {
                    ...
                    let result = Album(fetchResult: assetsfetchResult,
                                       ...
                                       rules: self.options.selectionRules)
