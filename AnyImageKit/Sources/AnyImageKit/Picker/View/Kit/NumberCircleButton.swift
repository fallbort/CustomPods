...
public final class NumberCircleButton: UIControl {
    ...
    private func setupView() {
        ...
        if self.style == .large {
            circleView.snp.makeConstraints { maker in
                maker.edges.equalToSuperview().inset(6)
            }
            ...
            circleView.snp.makeConstraints { maker in
                maker.edges.equalToSuperview().inset(19)
            }
            numLabel.snp.makeConstraints { maker in
                maker.edges.equalToSuperview().inset(18)
            }
...
extension NumberCircleButton {
    ...
    public func setTheme(_ theme: PickerTheme) {
