...
public protocol PickerPreviewIndexViewDelegate: AnyObject {
    
    func pickerPreviewIndexView(_ view: PickerPreviewIndexView, didSelect idx: Int)
}

public final class PickerPreviewIndexView: UIView {
    
    public weak var delegate: PickerPreviewIndexViewDelegate?
    ...
    public init(frame: CGRect, options: PickerOptionsInfo) {
    ...
    public func setManager(_ manager: PickerManager) {
