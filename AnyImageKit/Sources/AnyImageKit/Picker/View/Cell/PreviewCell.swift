...
public class PreviewCell: UICollectionViewCell {
    ...
    public var manager: PickerManager! {
        didSet {
            if oldValue == nil {
    ...
    public var centerOfContentSize: CGPoint {
    ...
    public func updateOptions(_ options: PickerOptionsInfo) {
...
extension Notification.Name {
    ...
    public static let previewCellDidDownloadResource = Notification.Name("org.AnyImageProject.AnyImageKit.Notification.Name.Picker.PreviewCellDidDownloadResource")
}
