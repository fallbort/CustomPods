...
public protocol PhotoPreviewControllerDataSource: AnyObject {
...
extension PhotoPreviewControllerDelegate {
    public func previewController(_ controller: PhotoPreviewController, didSelected index: Int) { }
    public func previewController(_ controller: PhotoPreviewController, didDeselected index: Int) { }
    public func previewController(_ controller: PhotoPreviewController, useOriginalImage: Bool) { }
    public func previewControllerDidClickBack(_ controller: PhotoPreviewController) { }
    public func previewControllerDidClickDone(_ controller: PhotoPreviewController) { }
}

public final class PhotoPreviewController: AnyImageViewController {
    ...
    public override func setStatusBar(hidden: Bool) {
...
extension PhotoPreviewController: PreviewCellDelegate {
    ...
    public func previewCellDidBeginPan(_ cell: PreviewCell) {
        delegate?.previewControllerWillDisappear(self)
        toolBarHiddenStateBeforePan = navigationBar.alpha == 0
    }
    
    public func previewCell(_ cell: PreviewCell, didPanScale scale: CGFloat) {
    ...
    public func previewCell(_ cell: PreviewCell, didEndPanWithExit isExit: Bool) {
        if isExit {
            dismiss(animated: true, completion: nil)
            setStatusBar(hidden: false)
    ...
    public func previewCellDidSingleTap(_ cell: PreviewCell) {
        setBar(hidden: navigationBar.alpha == 1, animated: false)
    }
    
    public func previewCellGetToolBarHiddenState() -> Bool {
...
extension PhotoPreviewController: PickerPreviewIndexViewDelegate {
    ...
    public func pickerPreviewIndexView(_ view: PickerPreviewIndexView, didSelect idx: Int) {
        currentIndex = idx
