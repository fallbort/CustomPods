...
final class AssetPickerViewController: AnyImageViewController {
    ...
    private var dataSource: UICollectionViewDiffableDataSource<Section, Asset> {
        get {
            if let data = _dataSource as? UICollectionViewDiffableDataSource<Section, Asset> {
                return data
            }else {
                let data = UICollectionViewDiffableDataSource<Section, Asset>(collectionView: collectionView) { (collectionView, indexPath, asset) -> UICollectionViewCell? in
                    return nil
                }
                _dataSource = data
                return data
    ...
    private var dataSource: UICollectionViewDiffableDataSource<Section, Asset> {
        get {
            if let data = _dataSource as? UICollectionViewDiffableDataSource<Section, Asset> {
                ...
                let data = UICollectionViewDiffableDataSource<Section, Asset>()
                _dataSource = data
                return data
            }
        }
