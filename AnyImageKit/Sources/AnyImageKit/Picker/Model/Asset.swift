...
public class Asset {
    ...
    /// 媒体类型
    public let mediaType: PHMediaType
    
    public var _images: [ImageKey: UIImage] = [:]
    public var __image: UIImage?
    public var videoDidDownload: Bool = false
    
    public var idx: Int
    public var state: State = .unchecked
    public var selectedNum: Int = 1
    
    public init(idx: Int, asset: PHAsset, selectOptions: PickerSelectOption) {
        self.idx = idx
        self.phAsset = asset
        self.mediaType = PHMediaType(asset: asset, selectOptions: selectOptions)
    }
}
...
extension Asset {
    ...
    public var _image: UIImage? {
        return ((_images[.output] ?? _images[.edited]) ?? _images[.initial]) ?? __image
    }
    
    public var _image2:UIImage? {
    ...
    public var isVideo: Bool {
        return idx == Asset.videoItemIdx
    }
    
    public static let cameraItemIdx: Int = -1
    public static let videoItemIdx: Int = -2
}
...
extension Asset {
    ...
    public func check(disable rules: [AssetDisableCheckRule]) {
...
extension Asset {
    ...
    public enum ImageKey: String, Hashable {
